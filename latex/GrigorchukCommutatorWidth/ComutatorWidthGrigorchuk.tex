...
$X$ is a set of \emph{variables}. As it should always be infinite countable it can be assumed to be equal to $\NN$. $G$ is some arbitrary group and $S_n$ is the 
Permutation group on $n$-Elements. $F_X$ denotes the free group on the generating set $X$.
...
The Grigorchuk $2$-group is a finitely generated group with finite state generators:
