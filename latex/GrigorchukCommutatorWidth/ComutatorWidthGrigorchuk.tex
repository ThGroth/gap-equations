...
\begin{re}
 ...
 attached gap file and the function \emph{GammaSimplify}.
\end{re}
...
%TODO Reference for the generators of the mcg. 
 ...
 \begin{align*}
  a_i&\colon& x_i&\mapsto x_{i-1}x_i & \textup{for }&i=2,4,\ldots,2n \\
  b_i&\colon&x_i&\mapsto x_{i+1}x_i & \textup{for }&i=1,3,\ldots,2n-1 \\
  c_i&\colon&x_i&\mapsto x_{i+1}x_{i+2}^{-1}x_i, && \\  
