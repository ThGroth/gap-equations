...
resulting equation.
For fixed $n$ we notate the free groups $F_{\mathcal{X}},F_{\mathcal{Y}}$ on the
following generating sets:
\begin{align*}
...
\begin{pro}\label{pro:existsNextPair}
 ...
 contains some $\gamma'$ such that for all $g$ with $\tau(g)=q$ the
...
\begin{proof}
 ...
 % More Details: Denote by $\Psi_i$ the embedding of $K\times H_i$ into $K$ and
 % by 
