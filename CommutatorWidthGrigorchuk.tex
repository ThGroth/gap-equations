...
refer to this group as the Grigorchuk $2$-group $G$.
...
\end{cor}
\begin{proof}
 Note that from corollary \ref{cor:KhasCW2} follows that $K\times K$ and furthermore $K^n$ have commutator width $2$. 
 In %\cite TODO
...
\begin{pro}
 Let $g\in G'$. Then the equation 
 \begin{align*}
  a^{x_1}a^{x_2}a^{x_3}a^{x_4}a^{x_5}a^{x_6}g=1
 \end{align*}
is solvable. 
\end{pro}
\begin{proof}
 Depending if $g^\pi=1$ or $g^\pi=((ad)^2)^\pi$ we consider the constrained equation
 $(a^{x_1}a^{x_2}a^{x_3}a^{x_4}a^{x_5}a^{x_6}g,\id)$ or
 $(a^{x_1}a^{x_2}a^{x_3}a^{x_4}a^{x_5}a^{x_6}g,(x_2\mapsto d^\pi,x_i\mapsto 1 \forall i\neq2))$.
 %TODO Continue
\end{proof}
