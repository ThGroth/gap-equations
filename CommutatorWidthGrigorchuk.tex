...
$F_{\mathcal{H}}=\left<\mathfrak{g}_1,\mathfrak{g}_2\right>$, and define a homomorphism  
\[\Phi_{\gamma}\colon
\begin{array}{rl}
...
\mathcal{X}}\to Q$
and $\gamma''
\in \Gamma_3^{\pi(g_1),\pi(g_1),n,Y_0}(\gamma)$
...
Notate the epimorphisms $i_{\mathcal{G}}\colon F_{\mathcal G} \to
G, \mathfrak g
\mapsto g$ and $i_{\mathcal{H}}\colon F_{\mathcal H} \to G, \mathfrak g_k
\mapsto g\at{k}$ and note that since $\nf_{\gamma,n,Y_0}$ is an 
$F_{\mathcal{H}}$-homomorphism $\mathfrak n :=(\id * i_{\mathcal H}) \circ \nf_
{\gamma,n,Y_0}$
maps $v_1w_2g_2w_1v_1g_1$ to $R_{2n-1}(Y_{*,*}) g_2^{{Y_{2n,1}}}
g_1$


%TODO: Is \nf mapping from F_X \to F_X * G or G-hom from F_X * G \to F_X *G ?
Hence the map
$s'\circ \mathfrak n$ is a solution for the
constrained
equation
...
\end{cases}\] %TODO Continue here: Phi_gamma defined on \mathfrak g ... 
