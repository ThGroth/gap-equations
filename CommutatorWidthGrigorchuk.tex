...
{as it follows, for example, from \cite{Rhemtulla:CommutatorsF2} or \cite{Culler:Surfaces}.}%Rhemtulla 68 A problem of bounded expressibility- TODO
 \replace{}{%
...
\begin{proof}
 ...
 \marginnote{\color{pink}This notation seems to be not defined in the text. It's the bounded product of the $H_i$}
\end{proof}
