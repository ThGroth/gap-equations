...
commutator width, because!!!NOT ``BECAUSE'': COMM WIDTH OF GP CAN BE SMALLER THAN THAT OF SUBGROUP. THIS IS SURPRISINGLY DIFFICULT TO PROVE...I DON'T KNOW ANY WAY OTHER THAN BAVARD DUALITY!!! it contains $F_{2n}$ for all $n$.
...
By Lemma~\ref{lem:finitelyManyConstraints} every element $\gamma\in Q^n$ has a representative in $Q^6$.
 ...
 following automorphisms of $F_{2n}$: !!!REFERENCE FOR GENERATORS OF SYMPLECTIC GP?!!!
 \begin{align*}
