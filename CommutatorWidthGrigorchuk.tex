...
\begin{proof}
 ...
 % $K\times H_{i-1}\times \cdots \times H_1$. If we denote by $H_\infty$ the group
 % generated by all the images of these maps in $K$ then the commutator width of 
 % $H_\infty$ has to be infinite.
