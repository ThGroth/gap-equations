...
\begin{itemize}
% \item there is a generator $Y_{\gamma'}$ in $F_{4n-1}$ and $x\in S$ such 
% that $\gamma'(Y_{\gamma'})=\pi(x)$. Denote by $F_{4n-2}$ the subgroup of
% $F_{4n-1}$ without the generator $Y_{\gamma'}$;
...
%   implies the solvability of $(R_ng,\gamma)$.
  \item[(*)]
  $F_{4n-1}$ factorizes as $F_{4n-2} * \langle Y_{\gamma'} \rangle$ where $\gamma'(Y_{\gamma'})=\pi(x)$; !!!!WHAT IS $x$? !!!!
