...
\[\ell_{Y_0}\colon\begin{array}{r@{\;}l}
  ...
  \end{cases}\end{array}
\]
maps $v\mathfrak g_1$ to $v_1w_2\mathfrak g_2w_1v_1\mathfrak g_1$ and
...
$\nf_{\gamma,n,Y_0}:=\nf_{v_1w_2\mathfrak g_2w_1v_1\mathfrak g_1}\colon F_{
\mathcal{Y}\setminus
\{Y_0,Y_0^{-1}\}}
...
{\gamma,n,Y_0}$
maps $v_1w_2g_2w_1v_1g_1$ to $R_{2n-1}(Y_{*,*}) g_2^{{Y_{2n,1}}}g_1$

Hence the map $s'\circ \mathfrak n$ is a solution for the constrained
equation $(v_1w_2g_2w_1v_1g_1,\gamma'' \circ \mathfrak{n}|_{F_{\mathcal
...
normalized is $v_1w_2R_{n-m}\mathfrak g_2w_1v_1R_{n-m}' \mathfrak g_1$. The
automorphisms
\begin{align*}
...
$\nf_{v_1w_2R_{n-m}\mathfrak g_2w_1v_1R_{n-m}'\mathfrak g_1} =
\psi_2\circ\nf_{v_1w_2\mathfrak g_2w_1v_1\mathfrak g_1}\circ \psi_1$ and
