...
\end{cor}
\begin{proof}
 To show that $K$ has commutator width $3$ it is sufficient, to show that the constrained equations $(R_3g,\id)$ have solutions for all $g\in K'$. 
...
\end{pro}
\begin{proof}
 %TODO wait until the new computation with 86 orbits complets. The earlier with 62 orbits brought the expected result.
 %But maybe now again bad pairs apear. 
\end{proof}
