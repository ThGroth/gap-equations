...
\begin{proof}
  ...
  variable $x\in X$ occurring in $\eq{E}$ then it also appears with
  ...
  In the unoriented case decompose the equation into $\eq{E} = uxvxw$ with
  ...
  $x^2N$. If $N\in \eq{U}_{r,s}\cup\thinspace \eq{O}_{0,t}$ for some $r,s,t$,
  ...
  \end{align*}
  If $M$ is still not in $\eq{O}_{0,s}$ this procedure can be repeated with
  $z$ instead of $x$.
\end{proof}
