...
\begin{cora}\label{cor:productOf6Conjugates}
  ...
  not products of $4$ conjugates of $a$.\marginnote{Is "a" as variable
  readable?}
\end{cora}
...
\mathcal{X}}]*1$.\marginnote{Sometimes we write $1$ and sometimes $\id$}
...
and $\RNK{G}{K\times K}$. \marginnote{Is $\RNK{G}{(K\times K)}$ better readable
or overloading?}
...
\includegraphics[width=\textwidth]{gap/PCD/noncomm29states}
 \marginnote{Should I make a nicer picture with less overlapping arrows?}
